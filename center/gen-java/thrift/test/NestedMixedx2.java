...
public class NestedMixedx2 implements org.apache.thrift.TBase<NestedMixedx2, NestedMixedx2._Fields>, java.io.Serializable, Cloneable, Comparable<NestedMixedx2> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                java.util.Set<java.lang.Integer> _elem207;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                java.util.Map<java.lang.Integer,java.util.Set<java.lang.String>> _elem220;
                ...
                {
                  {
                    ...
                    int _key223;
                    java.util.Set<java.lang.String> _val224;
  ...
  private static class NestedMixedx2TupleScheme extends org.apache.thrift.scheme.TupleScheme<NestedMixedx2> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, NestedMixedx2 struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list243 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.SET, iprot.readI32());
          struct.int_set_list = new java.util.ArrayList<java.util.Set<java.lang.Integer>>(_list243.size);
          java.util.Set<java.lang.Integer> _elem244;
          for (int _i245 = 0; _i245 < _list243.size; ++_i245)
          {
            {
              org.apache.thrift.protocol.TSet _set246 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, iprot.readI32());
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list256 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.MAP, iprot.readI32());
          ...
          java.util.Map<java.lang.Integer,java.util.Set<java.lang.String>> _elem257;
          for (int _i258 = 0; _i258 < _list256.size; ++_i258)
          {
            {
              org.apache.thrift.protocol.TMap _map259 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.SET, iprot.readI32());
              _elem257 = new java.util.HashMap<java.lang.Integer,java.util.Set<java.lang.String>>(2*_map259.size);
              int _key260;
              java.util.Set<java.lang.String> _val261;
