...
public class NestedListsBonk implements org.apache.thrift.TBase<NestedListsBonk, NestedListsBonk._Fields>, java.io.Serializable, Cloneable, Comparable<NestedListsBonk> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                java.util.List<java.util.List<Bonk>> _elem275;
  ...
  private static class NestedListsBonkTupleScheme extends org.apache.thrift.scheme.TupleScheme<NestedListsBonk> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, NestedListsBonk struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list289 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.LIST, iprot.readI32());
          struct.bonk = new java.util.ArrayList<java.util.List<java.util.List<Bonk>>>(_list289.size);
          java.util.List<java.util.List<Bonk>> _elem290;
          for (int _i291 = 0; _i291 < _list289.size; ++_i291)
          {
            {
              org.apache.thrift.protocol.TList _list292 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.LIST, iprot.readI32());
              _elem290 = new java.util.ArrayList<java.util.List<Bonk>>(_list292.size);
              java.util.List<Bonk> _elem293;
